...
class_label = 'multi' # SET THIS: "single" or "multi"
print('Running InceptionNet on {} label'.format(class_label))

'''
Reference: https://keras.io/applications/#usage-examples-for-image-classification-models
'''
X = joblib.load('inception_preprocessed.joblib')
X = preprocess(X)
...
epoch_file = "inception_" + class_label + "_model-{epoch:02d}.hdf5"
...
model.save('inception_' + class_label + '_model.hdf5')
